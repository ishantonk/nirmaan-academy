  ...
  return (
    <form action="/search" className="flex gap-2">
      <div className="relative flex-1">
        ...
        <Input name="q" placeholder="Search courses..." defaultValue={initialQuery} className="pl-10" />
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {categories.map((category) => (
            <Button key={category.id} variant="outline" className="h-auto py-4 justify-start" asChild>
