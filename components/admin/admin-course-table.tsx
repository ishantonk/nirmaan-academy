...
export function AdminCourseTable() {
  ...
  const toggleCourseFeatured = async (courseId: string, featured: boolean) => {
    try {
      const response = await fetch(`/api/admin/courses/${courseId}`, {
        method: "PATCH",
        headers: {
      ...
      toast.success("Course updated", {
        description: `The course has been ${featured ? "featured" : "unfeatured"} successfully.`,
      })
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => toggleCourseFeatured(course.id, !course.featured)}>
